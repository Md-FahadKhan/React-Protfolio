    ...
    <div
      ...
      <div className="  mx-auto max-w-screen-xl flex flex-col items-center justify-center h-full px-4 md:flex-row ">
        <div className="flex flex-col justify-center h-full w-[1000px] mt-10 ml-[500px] md:ml-0">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mt-20">
            Hello, My name is <br /> <span className='text-[crimson] text-5xl mt-2'>Evan Ahmed Fahad </span> 
            <div>
          ...
          <div>
            <button className="text-white mt-2 w-fit px-4 py-2 my-2 flex rounded-md items-center bg-gradient-to-r from-cyan-500 to-blue-500 text-2xl hover:scale-105">
              Hire me
            </button>
          </div>
        </div>
